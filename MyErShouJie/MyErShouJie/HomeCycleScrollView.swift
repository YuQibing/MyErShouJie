...
class HomeCycleScrollView: UIView {
...
extension HomeCycleScrollView {
    ...
    fileprivate func setupUI(){
        ...
        collectionView.register(HomeCycleViewCell.self, forCellWithReuseIdentifier: "cycle")
...
extension HomeCycleScrollView: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cycle", for: indexPath) as! HomeCycleViewCell
